...
practice-configurable requirement-rule UI (the requirement list itself —
`computeIntakeChecklist`'s eleven steps — is a fixed foundation, not yet
practice-editable), and staged/escalating reminder automation. See `ROADMAP.md`
§13 (P7) for the remaining slices.
