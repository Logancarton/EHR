...
11. [`PRESCRIPTION_RECOVERY.md`](PRESCRIPTION_RECOVERY.md) — ambiguous prescription attempt recovery, manual-vs-external evidence authority, retry unlocking, restart discovery, and stale callback handling.
