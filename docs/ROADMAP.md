...
**Browser-gate history:** green at `ae0850bbd988b29ad60a61fb1a3f0d7be4787ee8` when CB-5a closed, which is when CB-5a stopped blocking CB-7. It went red afterwards, CB-0b returned it to green on 2026-09-21 at **179/179**, and UI-7d left it green at **185/185**. Read the entries immediately below before quoting this line, and re-run the suite before quoting a figure: one member of the old group was an intermittent, and it has not been repaired.
