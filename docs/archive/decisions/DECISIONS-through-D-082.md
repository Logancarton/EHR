# Historical Monolithic Decision Log — through D-082

> Historical record — not the current decision discovery surface. Use [the active decision index](../../DECISIONS.md) and [individual ADR records](../../decisions/).
>
> This snapshot preserves the former monolithic log. Machine-local links were normalized to repository-relative targets.
