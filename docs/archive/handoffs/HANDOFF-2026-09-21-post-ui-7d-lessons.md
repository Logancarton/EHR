# Historical Handoff — after UI-7d and D-093

> Historical record — not authoritative for current work. Its "next step", UI-8, is complete and recorded in [ROADMAP_COMPLETED](../../ROADMAP_COMPLETED.md); the live queue is [ROADMAP](../../ROADMAP.md) *Next up*. The seven lessons below are preserved because they apply to any future slice that removes or replaces a surface; the full reasoning lives in [D-088](../../decisions/D-088.md) through [D-093](../../decisions/D-093.md).
>
...
([D-092](../../decisions/D-092.md)). The Level 1 work navigation now holds three direct
...
**Then [D-093](../../decisions/D-093.md) repaired a defect UI-7d shipped.** The practice
...
repaired all but one ([D-091](../../decisions/D-091.md)).
...
[`docs/ROADMAP.md`](../../ROADMAP.md) is the only ordered queue. Read **Owner UI migration
directive** first.
...
- **An existing surface is not a proven replacement.** UI-7a's Documents was in the `+`
  ...
  remove anything, and see [D-088](../../decisions/D-088.md) and
  [D-089](../../decisions/D-089.md).
...
- **"Named in the record" is not the same as "fine to ship".** D-092 recorded exactly
  ...
  what you can prove about it. [D-093](../../decisions/D-093.md) is the repair.
