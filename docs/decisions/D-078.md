...
Implementation status: Implemented: Intake can start without a visit and the queue can create standalone intake episodes.
...
Documentation date corrected 2026-09-19 against implementation commit `26809d6` (2026-09-17, America/Phoenix). The migration identity `2026-09-19-001-intake-episode-standalone` is unchanged.Decision: Two related gaps in how intake actually gets started, closed together.
