...
Implementation status: Implemented: three-row/no-left-sidebar shell; visible destination wording is amended by D-072 and D-083.
Amends: —
Amended by: [D-072](./D-072.md), [D-083](./D-083.md)
Supersedes: —
Superseded by: —
Related decisions: —
