...
function payload(patientId: string, encounterId: string, plan: string) {
  return {
    ...
    reviewOfSymptoms: "Denies depressed mood, anhedonia, hopelessness, or worthlessness.",
    treatmentResponse: "Improved",
    sideEffects: "None",
    assessment: "Stable",
    riskAssessment: "Denies suicidal and homicidal ideation, intent, and plan.",
    followUp: "Return in 4 weeks.",
    plan,
    cptCode: "99214",
    emLevel: "moderate",
    mse: {},
